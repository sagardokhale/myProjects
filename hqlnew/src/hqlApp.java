...
//		session.saveOrUpdate("insert into Book values(9,'Yayati','Khandekar',89.67)");
...
//		Query query=session.createQuery("select min(b.price) from Book b");
//		Query query=session.createQuery("select b.author from Book b where b.book='c'");
//		Object value=query.uniqueResult();
//		System.out.println(query.uniqueResult());
		List<Book> bookrecords=query.list();
